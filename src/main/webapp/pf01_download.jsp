...
<tr>
    <td>64 Corvair</td>
    <td><a href="<%= request.getContextPath() %>/sound/<%= product.getCode() %>/Corvair.mp3">MP3</a></td>
</tr>
<tr>
    <td>Whiskey Before Breakfast</td>
    <td><a href="<%= request.getContextPath() %>/sound/<%= product.getCode() %>/Whiskey.mp3">MP3</a></td>
</tr>
</table>
